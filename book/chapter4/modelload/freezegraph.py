# cmd
# python freezegraph.py --input_graph C:\tmp\mnistckp\model.pb --input_checkpoint C:\tmp\mnistckp\model.ckp --input_binary=true --output_graph C:\tmp\mnistckp\freezemodel.pb --output_node_names=predictionName
